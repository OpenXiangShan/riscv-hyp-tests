...
#define HSTATUS_HUPMM_RESERVED (1UL << 48)
#define HSTATUS_HUPMM_2 (2UL << 48)
#define HSTATUS_HUPMM_3 (3UL << 48)
...
#define MENVCFG_PBMTE (1UL << 62)
#define MENVCFG_ADUE  (1UL << 61)
#define MENVCFG_CDE   (1UL << 60)
#define MENVCFG_DTE   (1UL << 59)
#define MENVCFG_PMM_RESERVED (1UL << 32)
#define MENVCFG_PMM_2 (2UL << 32)
#define MENVCFG_PMM_3 (3UL << 32)
#define MENVCFG_CBZE  (1UL <<  7)
#define MENVCFG_CBCFE (1UL <<  6)
#define MENVCFG_CBIE  (3UL <<  4)
#define MENVCFG_SSE   (1UL <<  3)
#define MENVCFG_LPE   (1UL <<  2)
#define MENVCFG_FIOM  (1UL <<  0)
